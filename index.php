...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    <head>
        ...
        <title>Department of Mathematics, IIT Kharagpur</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0"> 
        <meta name="description" content="Department of Mathematics, IIT Kharagpur<" />
                      ...
                      <div class="col-md-3"><h1 style="border-bottom:1px solid #000000">Events</h1>
                          <div id="events" class="span6">
                              <div id="demo" class="scroll-text">
                                  <ul>
                                      <li>Your upward scrolling text goes here</li>
                                      <li>Second scrolling.</li>
                                      <li>Third scrolling</li>
                                      <li>Your upward scrolling text goes here</li>
                                      <li>Second scrolling.</li>
                                      <li>Third scrolling</li>
                                      <li>Your upward scrolling text goes here</li>
        ...
        <div id="footer">
            <footer class="footer container-fluid">
                <p class="muted credit">
                    ...
                    Kharagpur - 721302, West Bengal, INDIA<br>
                    Tel: +91-3222-282275 Fax : +91-3222-282276<br>
                </p>
            </footer>
        </div>
